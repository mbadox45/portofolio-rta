...
export default function Contact() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-b from-amber-950 to-black overflow-hidden">
      ...
      <div className="absolute top-0 min-h-screen w-full flex flex-col-reverse md:flex-row-reverse items-center justify-center gap-10 md:gap-10">
        {/* WhatsApp & Email */}
        <motion.div
          variants={fadeInRight}
          initial="hidden"
          animate="show"
          className="w-full md:w-1/2 flex flex-row md:flex-col gap-10 items-center justify-center"
        >
          {/* WhatsApp */}
          <motion.a
        ...
        {/* Description */}
        <div className="w-full md:w-2/3 px-5 md:px-40 text-center md:text-justify font-michroma flex flex-col gap-6 justify-center">
          {/* Title */}
          <motion.span
...
//   return (
//     <span className="text-gray-300 max-w-2xl text-xs md:text-md block whitespace-pre-line">
//       {displayedText}
...
function TypingParagraph() {
  ...
  return (
    <span className="text-gray-300 max-w-2xl text-xs md:text-lg block whitespace-pre-line">
      {displayedText}
